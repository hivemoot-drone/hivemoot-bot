 ...
 * Created or updated after each evaluateAutomerge call so PR authors can see
 * why their PR does or does not qualify without reading server logs.
 ...
 * Eligible PRs show a confirmation; ineligible PRs explain why with the reason.
 */
