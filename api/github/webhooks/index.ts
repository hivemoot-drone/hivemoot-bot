 ...
 *
 * Only called from webhook handlers (not reconciliation scripts) to surface
 * the current eligibility state to PR authors. Errors are swallowed so a
 * comment failure never fails the webhook event.
 */
